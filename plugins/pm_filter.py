...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNEL, LOG_CHANNEL, SUPPORT_CHAT, SUPPORT_GROUP, PICS, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, \
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Extra Mods', callback_data='extra_mods')
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('Manual Filters', callback_data='manual_filters'),
            InlineKeyboardButton('Auto Filters', callback_data='auto_filters')
        ],[
    ...
    elif query.data == "manual_filters":
        buttons = [[
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.MANUAL_FILTERS_TXT,
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
    elif query.data == "buttons":
        buttons = [[
            InlineKeyboardButton('◀️ Back', callback_data='manual_filters')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
    ...
    elif query.data == "auto_filters":
        buttons = [[
            InlineKeyboardButton('◀️ Back', callback_data='filters')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.AUTO_FILTERS_TXT,
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        ...
        buttons = [[
            InlineKeyboardButton('Owner Mods', callback_data='owner_mods')
        ],[
            InlineKeyboardButton('◀️ Back', callback_data='help')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.EXTRA_MODS_TXT,
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
    elif query.data == "owner_mods":
        buttons = [[
            InlineKeyboardButton('◀️ Back', callback_data='extra_mods')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.OWNER_MODS_TXT,
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
